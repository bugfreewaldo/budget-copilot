  ...
  fastify.get<{ Params: { id: string } }>(
    ...
    async (request, reply) => {
      try {
        ...
        if (!validation.success) {
          return reply.badRequest('Invalid account ID', validation.errors);
        }
    ...
    async (request, reply) => {
      try {
        ...
        if (!idValidation.success) {
          return reply.badRequest('Invalid account ID', idValidation.errors);
        }
  ...
  fastify.delete<{ Params: { id: string } }>(
    ...
    async (request, reply) => {
      try {
        ...
        // Delete account
        await db.delete(accounts).where(eq(accounts.id, request.params.id));
