  ...
  const weatherStates = [
    {
      ...
      message: '¡Buen flujo de caja! Puedes gastar $127 hoy',
      color: 'from-yellow-400 to-orange-400',
    },
    {
      emoji: '⛅',
      status: 'Parcialmente Nublado',
      message: 'Netflix se renueva en 3 días. ¡Planifica!',
      color: 'from-blue-400 to-cyan-400',
    },
    {
      emoji: '🌧️',
      status: 'Día Lluvioso',
      message: 'Alquiler el viernes. Evita compras grandes.',
      color: 'from-gray-400 to-blue-500',
    },
    {
      emoji: '⛈️',
      status: 'Alerta de Tormenta',
      message: '¡Saldo bajo! $89 hasta el día de pago.',
  ...
  const demoConversations = [
    {
      ...
      response: {
        ...
        analysis: [
          ...
          {
            icon: '📅',
            label: 'Alquiler en 8 días',
            value: '-$650',
            color: 'text-yellow-400',
          },
          {
            icon: '🔄',
            label: 'Netflix + Spotify esta semana',
            value: '-$25',
            color: 'text-yellow-400',
          },
          {
        ...
        verdict: {
          text: '✅ ¡Claro que sí! $50 para cine y cena está perfecto. ¡Pásala bien! 🎉',
          positive: true,
        },
    ...
    },
    {
      ...
      response: {
        ...
        verdict: {
          text: '🎯 A tu ritmo actual, serás libre de deuda en 19 meses.',
          positive: true,
        },
      ...
      response: {
        ...
        analysis: [
          ...
          },
          {
            ...
            value: '+$89 (Black Friday)',
            color: 'text-yellow-400',
          },
          {
            icon: '⛽',
            label: 'Gasolina',
            value: '+$34 (viaje a Colón)',
            color: 'text-yellow-400',
          },
          {
            icon: '📊',
            label: 'Exceso total',
            value: '$250 sobre presupuesto',
            color: 'text-red-400',
          },
        ],
        verdict: {
          text: '⚠️ Gastaste $250 más de lo usual, principalmente en comida afuera.',
          positive: false,
        },
    ...
    },
    {
      ...
      response: {
        ...
        analysis: [
          ...
          {
            icon: '🏋️',
            label: 'PowerClub (sin usar 2 meses)',
            value: '$45/mes',
            color: 'text-yellow-400',
          },
        ],
        verdict: {
          text: '💸 Total mensual: $73.97 en suscripciones',
          positive: true,
        },
    ...
    },
    {
      ...
      response: {
        ...
        analysis: [
          ...
          {
            icon: '📍',
            label: 'Viaje más frecuente',
            value: 'Casa → Oficina',
            color: 'text-green-400',
          },
        ],
        verdict: {
          text: '🚗 Has gastado $1,247 en Uber este año (promedio $104/mes)',
          positive: true,
        },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-950 text-white overflow-hidden">
      ...
      <main className="relative z-10 flex-1">
              ...
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3 lg:px-4 py-2 rounded-full bg-gray-800/50 border border-gray-700 mb-4 lg:mb-6">
                  ...
                  <span className="text-xs lg:text-sm text-gray-300">
                    IA Avanzada • Privacidad Total • Hecho para Panamá
                  </span>
                </div>
                ...
                <p className="text-sm lg:text-lg text-gray-400 mb-6 lg:mb-8">
                  Las apps de presupuesto tradicionales te hacen todo el
                  trabajo. Budget Copilot
                  <span className="text-cyan-400 font-semibold">
                    {' '}
                    piensa por ti
                  </span>{' '}
                  — predice crisis de efectivo, aprende tus hábitos, y responde
                  preguntas sobre tu dinero en español normal.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 mb-6 lg:mb-8 justify-center lg:justify-start">
                  <Link href="/register" className="w-full sm:w-auto">
                    <Button
                      size="lg"
                      className="w-full sm:w-auto bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 border-0 text-base lg:text-lg px-6 lg:px-8"
                    >
                      Crear Cuenta Gratis
                    </Button>
                  </Link>
                  <Link href="#demo" className="w-full sm:w-auto">
                    <Button
                      variant="outline"
                      size="lg"
                      className="w-full sm:w-auto border-gray-600 text-gray-300 hover:bg-gray-800 text-base lg:text-lg"
                    >
                      Ver Demo 🎬
                    </Button>
                  </Link>
              ...
              <div className="relative mt-8 lg:mt-0">
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-xl rounded-3xl border border-gray-700/50 p-6 lg:p-8 shadow-2xl">
                  ...
                  <div className="grid grid-cols-3 gap-2 lg:gap-4 pt-4 lg:pt-6 border-t border-gray-700/50">
                    ...
                    <div className="text-center">
                      <p className="text-lg lg:text-2xl font-bold text-cyan-400">
                        23
                      </p>
        ...
        <section
          id="compare"
          className="py-12 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/50"
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-800/30 rounded-2xl p-8 border border-gray-700/50">
                <h4 className="text-xl font-bold mb-6 text-gray-400 flex items-center gap-2">
                  <span className="text-2xl">😴</span> Apps de Presupuesto
                  Tradicionales
                </h4>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-300">
                        Entrada manual y sincronización bancaria
                      </p>
                      <p className="text-sm text-gray-500">
                        Las conexiones de Plaid fallan. Escribir todo es
                        tedioso.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Te muestra lo que pasó, no lo que viene.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-300">
                        Categorización tonta
                      </p>
                      <p className="text-sm text-gray-500">
                        "AMZN*2847XK" → "Compras" 🙄 Qué útil.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-300">
                        Sin contexto, sin personalidad
                      </p>
                      <p className="text-sm text-gray-500">
                        Gráficos aburridos y números. Sin consejos prácticos.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-300">
                        No funciona en LATAM
                      </p>
                      <p className="text-sm text-gray-500">
                        ¿Bancos de Panamá? Olvídalo.
                      </p>
                    </div>
                  </li>
                </ul>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-white">
                        Análisis de capturas y PDFs
                      </p>
                      <p className="text-sm text-gray-400">
                        Toma una foto de tu app bancaria. La IA extrae todo.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-white">
                        Predice crisis de efectivo
                      </p>
                      <p className="text-sm text-gray-400">
                        "¡Alerta de tormenta! $89 hasta el día de pago"
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Sabe que gastas de más los viernes. Te avisa.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-white">
                        Pregunta lo que sea en español
                      </p>
                      <p className="text-sm text-gray-400">
                        "¿Me alcanza para un PS5?" → Respuesta real.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Banco General, Banistmo, BAC → Todos soportados.
                      </p>
                    </div>
                  </li>
                </ul>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="group bg-gray-900/50 rounded-2xl p-6 border border-gray-800 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
                ...
                <p className="text-gray-400">
                  Toma foto de tu app bancaria o estado de cuenta. La IA extrae
                  las transacciones al instante. Sin escribir, sin Plaid.
                </p>
                <div className="mt-4 pt-4 border-t border-gray-800">
                  <span className="text-xs text-cyan-400 font-mono">
                    Funciona con: PNG, JPG, PDF
                  </span>
                </div>
              </div>
              ...
              <div className="group bg-gray-900/50 rounded-2xl p-6 border border-gray-800 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
                ...
                <p className="text-gray-400">
                  Reporte diario: "Nublado con probabilidad de sobregiro."
                  Conoce tu pronóstico financiero de un vistazo.
                </p>
                <div className="mt-4 pt-4 border-t border-gray-800">
              ...
              <div className="group bg-gray-900/50 rounded-2xl p-6 border border-gray-800 hover:border-pink-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
                ...
                <p className="text-gray-400">
                  Ve tu "fecha de muerte de deuda" — cuándo serás libre. Compara
                  estrategias avalancha vs bola de nieve.
                </p>
                <div className="mt-4 pt-4 border-t border-gray-800">
                  <span className="text-xs text-pink-400 font-mono">
                    $50/mes extra → 14 meses antes
                  </span>
                </div>
              </div>
              ...
              <div className="group bg-gray-900/50 rounded-2xl p-6 border border-gray-800 hover:border-green-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
                ...
                <p className="text-gray-400">
                  Desliza a la derecha para aprobar, izquierda para rechazar. La
                  IA aprende tus categorías con el tiempo. Cero trabajo manual.
                </p>
                <div className="mt-4 pt-4 border-t border-gray-800">
                  <span className="text-xs text-green-400 font-mono">
                    95% precisión después de 50 swipes
                  </span>
                </div>
              </div>
              ...
              <div className="group bg-gray-900/50 rounded-2xl p-6 border border-gray-800 hover:border-yellow-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
                ...
                <p className="text-gray-400">
                  "23 días hasta $0 al ritmo actual de gasto." Ve el futuro
                  antes de que pase.
                </p>
                <div className="mt-4 pt-4 border-t border-gray-800">
              ...
              <div className="group bg-gray-900/50 rounded-2xl p-6 border border-gray-800 hover:border-orange-500/50 transition-all duration-300 hover:transform hover:-translate-y-1">
                ...
                <p className="text-gray-400">
                  "¡82% de tu fondo de vacaciones! Pon $47 esta semana para
                  mantenerte en camino."
                </p>
                <div className="mt-4 pt-4 border-t border-gray-800">
                  <span className="text-xs text-orange-400 font-mono">
                    Contribuciones recomendadas por IA
                  </span>
                </div>
              </div>
            </div>
        ...
        >
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 lg:mb-12">
              ...
              <p className="text-base lg:text-xl text-gray-400">
                Esto es lo que nos hace diferentes. Preguntas reales, respuestas
                reales.
              </p>
              <p className="text-xs lg:text-sm text-cyan-400 mt-2">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-xs text-cyan-100">
                      En línea • Analizando tus finanzas
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-gray-900 to-gray-800 rounded-3xl p-12 border border-gray-700/50 text-center">
                ...
                <h3 className="text-4xl font-bold mb-4">
                  ¿Listo para una IA que de verdad{' '}
                  <span className="text-cyan-400">entienda</span> tu plata?
                </h3>
                <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                  Deja de presupuestar a la antigua. Deja que tu copiloto de IA
                  haga el trabajo pesado mientras tú te enfocas en vivir tu
                  vida.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/register">
                    <Button
                      size="lg"
                      className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 border-0 text-lg px-8 w-full sm:w-auto"
                    >
                      Crear Cuenta Gratis
                    </Button>
                  </Link>
                  <Link href="/login">
                    <Button
                      variant="outline"
                      size="lg"
                      className="border-gray-600 text-gray-300 hover:bg-gray-800 text-lg w-full sm:w-auto"
                    >
                      Ya tengo cuenta
                    </Button>
                  </Link>
                ...
                <p className="text-sm text-gray-500 mt-6">
                  Sin tarjeta de crédito requerida • Solo crea tu cuenta para
                  comenzar
                </p>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Tu compañero financiero con IA. Hecho por humanos, para humanos
                (con ayuda de IA 😉).
              </p>
            </div>
            <div>
