                  ...
                  {editDebt.minimum_payment_type === 'fixed' ? (
                    ...
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        className="w-24 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-cyan-500"
                        placeholder="2"
                        step="0.1"
                        min="0"
                        max="100"
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-32 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-cyan-500"
                      placeholder="28.9"
                      step="0.1"
                      required
                    />
