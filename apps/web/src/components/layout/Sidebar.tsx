...
export function Sidebar({ children }: SidebarProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      {/* Mobile Drawer */}
      <aside
        className={`lg:hidden fixed top-0 left-0 z-50 h-full w-[85vw] max-w-72 bg-gray-900 border-r border-gray-800 transform transition-transform duration-300 ease-in-out ${
